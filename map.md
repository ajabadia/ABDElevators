...
| Ruta | Funcionalidad | Última Revisión |
|------|---------------|-----------------|
| `/admin` | Dashboard principal de administración. | 2026-02-14 |
| `/admin/profile` | Gestión de identidad, seguridad y preferencias del usuario. | 2026-02-14 |
...
| `/entities` | ❌ Ruta incorrecta | La ruta correcta es `/technical/entities` |

        ...
        <div className={cn(
            ...
            <div className="flex items-center gap-3">
                ...
                <div className="flex-1">
                    <p className="text-[10px] uppercase font-bold text-slate-400 tracking-wider">Sovereign Tool</p>
                    <p className="text-sm font-semibold text-slate-800">{data.label || 'Ejecutar Función'}</p>
                </div>
            </div>

            <div className="mt-3 pt-2 border-t border-indigo-100">
                <div className="flex items-center gap-1.5 p-1.5 bg-slate-50 rounded-md border border-slate-100">
                    <Cpu className="w-3 h-3 text-indigo-400" />
                    <span className="text-[10px] font-mono text-slate-600 truncate">{data.toolId || 'unassigned_tool'}</span>
                </div>
            </div>

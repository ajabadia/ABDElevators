...
import { BrainCircuit, ShieldCheck, Zap, Cog, Activity } from "lucide-react";
...
export const AiBrainStateCard: React.FC<AiBrainStateCardProps> = ({ stats }) => {
    ...
    return (
        <ContentCard
            ...
            className="h-full border-l-4 border-l-purple-500 shadow-lg hover:shadow-xl transition-all"
        >

...
import { LayoutDashboard, FileText, History, Settings, Shield, Users, ChevronLeft, ChevronRight, LogOut, CheckSquare, Bell, Terminal } from 'lucide-react';
    ...
    return (
        ...
        >
            <div className={cn(
                ...
                {isCollapsed && (
                    <div className="mx-auto text-teal-400 font-bold text-xl">ABD</div>
                )}
            </div>

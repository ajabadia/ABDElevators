 ...
 * Conecta vía SSE al motor agéntico para mostrar trazas en tiempo real.
...
export function AgentTraceViewer({ pedidoId, onComplete }: AgentTraceViewerProps) {
    ...
    const startAnalysis = () => {
        ...
        eventSource.addEventListener('complete', (e: Event) => {
            addTrace("Análisis agéntico finalizado correctamente.", 'success');
        ...
        eventSource.addEventListener('error', (e: Event) => {
            try {
                ...
                addTrace(`Error de conexión con el agente.`, 'error');
            }
            setIsAnalyzing(false);
            setStatus('error');
            eventSource.close();

    ...
    return (
        <PageContainer className="p-4 space-y-6 max-w-md mx-auto pb-24">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-2xl font-black tracking-tight">TechMode</h1>
            ...
            <div className="fixed bottom-6 left-4 right-4 h-16 bg-white/80 dark:bg-slate-950/80 backdrop-blur-xl border border-border rounded-[24px] shadow-2xl flex items-center justify-around px-4">
                <Button variant="ghost" size="icon" className="rounded-xl text-primary bg-primary/5">

...
import {
    Plus, Shield, Search, Filter as FilterIcon, ShieldAlert,
    Globe, Clock, Loader2, Info, LayoutGrid, List
} from 'lucide-react';
    ...
    return (
        <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
            ...
            <div className="space-y-6">
                ...
                {viewMode === 'grid' ? (
                    <PermissionMatrixGrid policies={filteredPolicies} isLoading={isLoading} />
                ) : (
